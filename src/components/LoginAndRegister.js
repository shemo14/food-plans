            ...
            <Container style={{ backgroundColor: '#2e3f59' }}>
                <Content>
                    ...
                    <View style={{ alignItems: 'center' }}>
                        <Button onPress={()=> this.navigateToLogin()} block style={{ backgroundColor: '#eb5355', alignSelf: 'center', marginBottom: 20, width: '95%', borderRadius: 4, justifyContent: 'center', lineHeight: 40 }}>
                            <Text style={{ color: '#fff', textAlign: 'center' , fontFamily:"RegularFont" }}>تسجيل الدخول</Text>
                        </Button>
                        <Button onPress={()=> this.props.navigation.navigate("register")} block style={{ backgroundColor: '#f0b918', alignSelf: 'center', width: '95%', borderRadius: 4, justifyContent: 'center', lineHeight: 40 }}>
